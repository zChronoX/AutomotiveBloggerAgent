...
dataset_name = "Blogger_Test_Dataset V1.1"
dataset_description = "Dataset di test per la valutazione del Blogger Copilot"

# Prompt di prova: coprono i vari scenari del progetto (post, news, recensione, KG, eventi)
test_inputs = [
    ...
    "Oggi vorrei scrivere un post sulle batterie allo stato solido, che ne pensi?",  # Testa il Knowledge Graph
...
def get_or_create_dataset():
    ...
    (utile per poter rilanciare lo script senza doverlo cancellare a mano).
    """
...
def main():
    ...
    print(f"Dataset popolato con {len(test_inputs)} esempi. Visibile sulla dashboard di LangSmith.")
